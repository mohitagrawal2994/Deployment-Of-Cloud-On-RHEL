...
if((osname=="")| (c=="")| (r=="")|(h=="")):
	...
	if(osname=="Red Hat Enterprise Linux 5.7"):
		osn="rhel5.7"+uid
		pth="/var/www/html/OS/rhel5.7.iso"
	elif(osname=="Red Hat Enterprise Linux 6.6"):
		osn="rhel6.4"+uid
		pth="/var/www/html/OS/rhel6.6.iso"
	elif(osname=="Red Hat Enterprise Linux 7.0"):
		osn="rhel7.0"+uid
		pth="/var/www/html/OS/rhel7.0.iso"
