...
print"""</span>
	   ...
	   <div id="osl" name="osl">
	   <a id="osl1" name="osl1" href="http://192.168.0.8/cgi-bin/nstaas.py"><button type="button" style="font-size:30px; color:red; padding:20px; padding-left:40px; padding-right:40px;">PD</button></a>
	   <a id="osl2" name="osl2" href="http://192.168.0.8/cgi-bin/hstaas.py"><button type="button" style="font-size:30px; color:red; padding:20px; padding-left:40px; padding-right:40px; background-color:green;">HDD</button></a>
	   </div>
	   <div id="crt" name="crt">
	     <form method="post" action="http://192.168.0.8/cgi-bin/STAAS/createhdd.py" autocomplete="off">
	   ...
	   <div id="mdfy" name="mdfy">
	     <form method="post" action="http://192.168.0.8/cgi-bin/STAAS/modifyhdd.py" autocomplete="off">
	       <fieldset style="border:double;color:gold;"><legend>MODIFY STORAGE</legend>
	       <div style="padding:20px;">
	         Extend SIZE : <input type="radio" id="size" name="size"></input>
	         Reduce SIZE : <input type="radio" id="size" name="size"></input><br><br>
	         Final SIZE(GB) : 
		 <select id="size" name="size">
		 <option>1</option>
		 <option>2</option>
	   ...
	   <a href="http://192.168.0.8/cgi-bin/STAAS/getstor.py" id="gostor" name="gostor"><button type="button" style="font-size:20px; padding:20px; border-radius:15px; color:yellow; background-color:black;">Get Storage</button></a>
"""
